...
class Aauth {
     ...
     */
    public function create_user($email, $pass, $name='', $surname='') {
        ...
        if ($surname !='' and !ctype_alnum(str_replace($this->config_vars['valid_chars'], '', $surname))){
            $this->error($this->CI->lang->line('name_invalid'));
            $valid = false;
        }
     ...
     * @return bool Update fails/succeeds
     */
    public function update_user($user_id, $email = FALSE, $pass = FALSE, $name = FALSE,  $surname = FALSE) {
